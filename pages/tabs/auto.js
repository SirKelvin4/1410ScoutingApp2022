    ...
    return (
        <div className='Page'>
            ...
            <ButtonGroup variant='contained' color='primary' aria-label='split button' disableRipple fullWidth disableElevation>
                <Button id='1' onClick={() => {data.autonomous.auto_high_hub++; document.getElementById('1').innerText=`High Hub Cargo Scored: ${data.autonomous.auto_high_hub}`}}>auto_high_hub</Button>
            ...
            <ButtonGroup variant='contained' color='primary' aria-label='split button' disableRipple fullWidth disableElevation>
                <Button id='2' onClick={() => {data.autonomous.auto_low_hub++; document.getElementById('2').innerText=`Low Hub Cargo Scored: ${data.autonomous.auto_low_hub}`}}>auto_low_hub</Button>
            ...
            <ButtonGroup variant='contained' color='secondary' aria-label='split button'  disableRipple fullWidth disableElevation>
                <Button id='3' className='Missed' onClick={() => {data.autonomous.auto_shots_missed++; document.getElementById('3').innerText=`Shots Missed: ${data.autonomous.auto_shots_missed}`}}>shots_missed</Button>
